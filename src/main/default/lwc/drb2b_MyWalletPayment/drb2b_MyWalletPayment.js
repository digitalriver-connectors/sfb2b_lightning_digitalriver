...
export default class Drb2b_MyWalletPayment extends LightningElement {
    initilized = false;
    isLoading = false;
    UserId = USER_ID;
    @api cart;
    ...
    connectedCallback() {
       ...
       // this.getAllStoredPayments();
        ...
        //this.callResponseHandler = this.callResponseHandler.bind(this);
    ...
    handleAuthError(data) {
        this.isLoading = false;
        this.showToast({ message: this.label.sourceAuthenticationFailed, variant: "error" });
    }
}
